...
<form action="<?= base_url() . 'surat/create'; ?>" method="POST" enctype="multipart/form-data" class="needs-validation" novalidate>
    <div class="row g-2">
        <div class="col-sm-6">
            <label for="nomor_surat" class="form-label">Nomor Surat</label>
            <input name="nomor_surat" type="text" class="form-control mb-2 <?= (form_error('nomor_surat')) ? 'is-invalid' : ''; ?>" id="nomor_surat" placeholder="" value="<?= set_value('nomor_surat'); ?>" required>
            <span class="text-danger"><?= form_error('nomor_surat'); ?></span>
        </div>
        <div class="col-sm-6">
            <label for="judul" class="form-label">Judul</label>
            <input name="judul" type="text" class="form-control mb-2 <?= (form_error('judul')) ? 'is-invalid' : ''; ?>" id="judul" placeholder="" value="<?= set_value('judul'); ?>" required>
